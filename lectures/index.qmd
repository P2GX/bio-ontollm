...
*   [What to expect from this course](overview.qmd)
*   [Lecture 1: Ontologies: OBO, RDF, RDFS, and OWL](ontology1.qmd)
*   [Lecture 2: Gene Ontology (GO) and Overrepresentation Analysis](ontology2.qmd)
*   [Lecture 3: Bayesian algorithms for GO: Model-based gene-set analysis](ontology3.qmd)
*   [Lecture 4: Human Phenotype Ontology: Semantic similarity algorithms](ontology4.qmd)
*   [Lecture 5: From Logistic Regression to Neural Foundations](logreg.qmd)
*   [Lecture 6: Neural networks](neural.qmd)
*   Lecture 7: RNNs and LSTM (to do)
*   Lecture 8: Embeddings and Word2Vec (partially finisheed)
*   [Lecture 9: Encoders](encoder.qmd)
